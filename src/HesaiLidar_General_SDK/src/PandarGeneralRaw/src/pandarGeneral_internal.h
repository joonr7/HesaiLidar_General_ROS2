...
class PandarGeneral_Internal {
 public:
  ...
  int Start();
  void Stop();
  void PushScanPacket(hesai_lidar::msg::PandarScan::Ptr scan);
 ...
 private:
  ...
  void EmitBackMessege(char chLaserNumber, boost::shared_ptr<PPointCloud> cld, hesai_lidar::msg::PandarScan::Ptr scan);
  ...
  boost::function<void(boost::shared_ptr<PPointCloud> cld, double timestamp, hesai_lidar::msg::PandarScan::Ptr scan)>
      pcl_callback_;
