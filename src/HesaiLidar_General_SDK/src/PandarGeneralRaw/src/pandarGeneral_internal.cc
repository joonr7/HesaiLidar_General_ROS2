...
PandarGeneral_Internal::PandarGeneral_Internal(
    ...
    boost::function<void(boost::shared_ptr<PPointCloud>, double, hesai_lidar::msg::PandarScan::Ptr)> pcl_callback,
...
PandarGeneral_Internal::PandarGeneral_Internal(std::string pcap_path, \
    boost::function<void(boost::shared_ptr<PPointCloud>, double, hesai_lidar::msg::PandarScan::Ptr)> \
...
void PandarGeneral_Internal::ProcessLiarPacket() {
  ...
  hesai_lidar::msg::PandarScan::Ptr scan(new hesai_lidar::msg::PandarScan);
...
void PandarGeneral_Internal::EmitBackMessege(char chLaserNumber, boost::shared_ptr<PPointCloud> cld, hesai_lidar::msg::PandarScan::Ptr scan) {
  if (pcl_type_) {
    for (int i=0; i<chLaserNumber; i++) {
...
void PandarGeneral_Internal::PushScanPacket(hesai_lidar::msg::PandarScan::Ptr scan) {
